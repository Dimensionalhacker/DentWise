  ...
  return (
    <section className="relative h-screen flex items-center overflow-hidden pt-20">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-background via-muted/5 to-primary/5">
        ...
        [mask-image:radial-gradient(ellipse_60%_50%_at_50%_0%,#000_70%,transparent_110%)] opacity-20"
        ></div>
      </div>
      {/* GRADIENT ORBS */}
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-10">
              <div className="space-y-6">
                {/* BADGE */}
                <div
                  className="inline-flex items-center gap-2 px-4 py-2. bg-gradient-to-r from-primary/10 to bg-primary/5 rounded-full 
                border border-primary/20 bachdrop-blur-sm"
                >
